...
function detail(
  ...
  return {
    ...
    ...(course.systemAuthor !== undefined && { systemAuthor: course.systemAuthor }),
    liked: false,
...
export const mockCommunityReviews: Record<number, CourseReview[]> = {
  910001: [
    { reviewId: 940001, userId: 601, userName: '제주한바퀴', userTitle: '첫 번째 영감', experienceType: 'FOLLOWED', contents: '혼밥 장소와 산책 순서가 자연스러워서 그대로 다녀왔어요. 저녁에도 일정이 부담스럽지 않았습니다.', createdAt: '2026-08-22T20:10:00', tags: tags(1001, 1002) },
...
export const mockGamificationProfile: GamificationProfile = {
  ...
  equippedTitleName: '첫 번째 영감',
  titles: [
    { code: 'FIRST_JOURNEY', name: '첫 발자국', description: '첫 코스를 공개했어요.', unlocked: true, equipped: false, progress: 1, target: 1 },
    { code: 'COURSE_MAKER', name: '루트 메이커', description: '공개 코스 5개를 만들어요.', unlocked: false, equipped: false, progress: 3, target: 5 },
    { code: 'FIRST_INSPIRATION', name: '첫 번째 영감', description: '내 코스가 다른 여행자의 일정이 되었어요.', unlocked: true, equipped: true, progress: 1, target: 1 },
    { code: 'ITINERARY_SHARER', name: '라이징 플래너', description: '5명의 여행자가 내 코스를 가져갔어요.', unlocked: false, equipped: false, progress: 1, target: 5 },
    { code: 'SOLO_GUIDE', name: '트립 큐레이터', description: '20명의 여행자가 내 코스를 가져갔어요.', unlocked: false, equipped: false, progress: 1, target: 20 },
    { code: 'TASTE_SHARER', name: '취향의 발견', description: '내 코스가 좋아요 10개를 받았어요.', unlocked: false, equipped: false, progress: 4, target: 10 },
    { code: 'BELOVED_ROUTE', name: '모두의 선택', description: '내 코스가 좋아요 50개를 받았어요.', unlocked: false, equipped: false, progress: 4, target: 50 },
    { code: 'SEOUL_EXPLORER', name: '서울 마스터', description: '서울 공개 코스 3개를 만들었어요.', unlocked: false, equipped: false, progress: 2, target: 3 },
    { code: 'BUSAN_TRAVELER', name: '부산 마스터', description: '부산 공개 코스 3개를 만들었어요.', unlocked: false, equipped: false, progress: 0, target: 3 },
    { code: 'JEJU_SLOW_TRAVELER', name: '제주 마스터', description: '제주 공개 코스 3개를 만들었어요.', unlocked: false, equipped: false, progress: 1, target: 3 },
  ],
}
