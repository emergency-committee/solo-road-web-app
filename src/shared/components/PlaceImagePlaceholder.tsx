...
export type PlaceImagePlaceholderVariant = 'food' | 'place'
 ...
 */
export function PlaceImagePlaceholder({
  className,
  variant = 'place',
}: {
  className?: string
  variant?: PlaceImagePlaceholderVariant
}) {
  const Icon = variant === 'food' ? UtensilsCrossed : MapPin

  return (
    <div
      className={cn(
        'bg-surface-container-high text-primary/75 relative flex size-full items-center justify-center overflow-hidden',
        className,
      )}
    >
